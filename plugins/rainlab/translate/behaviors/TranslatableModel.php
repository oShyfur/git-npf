...
class TranslatableModel extends TranslatableBehavior
{
    ...
    protected function storeTranslatableBasicData($locale = null)
    {
        ...
        $obj = Db::connection($this->model->connection)->table('rainlab_translate_attributes')
        ...
        if ($obj->count() > 0) {
            ...
            Db::connection($this->model->connection)->table('rainlab_translate_attributes')->insert([
                'locale' => $locale,
