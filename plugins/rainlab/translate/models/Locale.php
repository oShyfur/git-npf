...
class Locale extends Model
{
    ...
    {
        return self::getSiteDefaultLocale();
    ...
    // new code by arif hossain
    public static function getSiteDefaultLocale()
    {

        if (request()->isTenant) {
            $siteDefault = NP::getSite('default_lang');
            self::$defaultLocale = self::where('code', $siteDefault)->first();
        }
        else
        self::$defaultLocale = self::where('is_default', true)->first();
    ...
    public static function getSiteLocales()
    {
        ...
        $siteLanguages = NP::getSite('languages');
        if (!strpos(request()->path(), 'contents')) {
            $siteLanguages = NP::defaultLocales();
        }
    ...
    // new code by arif hossain
    public static function listAvailableNew()
    {
    ...
    {
        // code by arif hossain
        return self::getSiteLocales();
