 ...
 * Model
 */
class SubInitiativeTcv extends NPContentsBaseModel
{
     ...
     */
    public $table = 'np_contents_sub_initiative_tcv';

    /**
     * @var array Validation rules
     */
    public $rules =['initiative_category_id'=>'required','initiative_sub_category_id'=>'required','title'=>'required','value'=>'required'];
