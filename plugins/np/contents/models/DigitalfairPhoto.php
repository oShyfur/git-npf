 ...
 * Model
 */
class DigitalfairPhoto extends NPContentsBaseModel
{
     ...
     */
    public $table = 'np_contents_digitalfair_photo';

    /**
     * @var array Validation rules
     */
    public $rules =['title'=>'required', 'images'=>'required', 'digitalfair_year'=>'required'];
