 ...
 * Model
 */
class GolpoNoyShotti extends NPContentsBaseModel
{
     ...
     */
    public $table = 'np_contents_golpo_noy_shotti';

    /**
     * @var array Validation rules
     */
    public $rules =['title'=>'required','image'=>'required','sort_order'=>'required'];
