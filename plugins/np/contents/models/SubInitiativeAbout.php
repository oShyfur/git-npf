 ...
 * Model
 */
class SubInitiativeAbout extends NPContentsBaseModel
{
     ...
     */
    public $table = 'np_contents_sub_initiative_about';

    /**
     * @var array Validation rules
     */
    public $rules =['title'=>'required','body'=>'required','initiative_category_id'=>'required','initiative_sub_category_id'=>'required'];
