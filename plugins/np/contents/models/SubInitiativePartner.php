 ...
 * Model
 */
class SubInitiativePartner extends NPContentsBaseModel
{
     ...
     */
    public $table = 'np_contents_sub_initiative_partners';

    /**
     * @var array Validation rules
     */
    public $rules =['title'=>'required','initiative_category_id'=>'required','initiative_sub_category_id'=>'required'];
