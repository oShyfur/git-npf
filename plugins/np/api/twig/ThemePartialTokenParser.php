 ...
 */
class ThemePartialTokenParser extends TwigTokenParser
{
    /**
    ...
    public function parse(TwigToken $token)
    {
        ...
        return new ThemePartialNode(new TwigNode($nodes), $paramNames, $body, $token->getLine(), $this->getTag());
    }
