...
class AppLoginResponseDTO
{
    ...
    public function getInchargeLabel()
    {
    ...
    public function getOfficeMinistryNameEng()
    {
        return $this->office_ministry_name_eng;
    }

    public function getOfficeMinistryNameBng()
    {
        return $this->office_ministry_name_bng;
    }

    public function getUnitNamEng()
    {
    ...
    public function setEmployeeRecordId($employee_record_id)
    {
    ...
    public function setOfficeUnitId($office_unit_id)
    {
        $this->office_unit_id = $office_unit_id;
    }

    public function setInchargeLabel($incharge_label)
    {
        $this->incharge_label = $incharge_label;
    }

    public function setOfficeUnitOrganogramId($office_unit_organogram_id)
    {
        $this->office_unit_organogram_id = $office_unit_organogram_id;
    }

    public function setOfficeNameEng($office_name_eng)
    {
        $this->office_name_eng = $office_name_eng;
    }

    public function setOfficeNameBng($office_name_bng)
    {
        $this->office_name_bng = $office_name_bng;
    }

    public function setOfficeMinistryId($office_ministry_id)
    {
        $this->office_ministry_id = $office_ministry_id;
    }

    public function setOfficeMinistryNameEng($office_ministry_name_eng)
    {
        $this->office_ministry_name_eng = $office_ministry_name_eng;
    }

    public function setOfficeMinistryNameBng($office_ministry_name_bng)
    {
        $this->office_ministry_name_bng = $office_ministry_name_bng;
    }

    public function setUnitNameEng($unit_name_eng)
    {
        $this->unit_name_eng = $unit_name_eng;
    }

    public function setUnitNameBng($unit_name_bng)
    {
