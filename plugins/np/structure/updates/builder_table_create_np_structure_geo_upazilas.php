...
class BuilderTableCreateNpStructureGeoUpazilas extends Migration
{
    public function up()
    {
        Schema::create('np_structure_geo_upazilas', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('np_structure_geo_upazilas');
    }
}
