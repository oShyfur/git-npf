...
return [
    ...
    */
    ...
    'backendSkin' => 'Np\Structure\Classes\BackendSkin',
    ...
    */
    ...
    'storage' => [
        ...
        'uploads' => [
            'disk'   => env('DISK', 'local'),
            'folder' => 'uploads',
            // 'path'   => env('CDN_PUBLIC_URL', '/storage/app/uploads'),
            'path'   => env('CDN_PUBLIC_URL', '/storage/app/'),      //local
            'migrated_folder'   => env('CDN_OLD_ASSET_FOLDER', 'files'),
        ],
    ...
    */
    ...
    /* accepted file types for media manager*/
