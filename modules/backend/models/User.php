...
class User extends UserBase
{
    ...
    public $rules = [
        ...
        'password' => 'required:create|between:4,255|min:8|regex:/^.*(?=.{3,})(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[\d\x])(?=.*[@!$#%&?]).*$/|confirmed',
    ...
    public function filterFields($fields, $context = null){
        ...
        if($backendUser->is_superuser != 1 && $context != "create"){
    ...
    public function getAvatarThumb($size = 25, $options = null)
    {
        ...
        return env('CDN_PUBLIC_URL','http://file.portal.gov.bd') . "/media/central/uploaded-files/avatar/user.png";
    }
